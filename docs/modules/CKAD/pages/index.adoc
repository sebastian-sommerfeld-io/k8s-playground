...
. Take a look at the candidate handbook on the vertification website -> https://docs.linuxfoundation.org/tc-docs/certification/lf-handbook2 and make sure the minimum system requirements are met (https://syscheck.bridge.psiexams.com). Take a look at the other pages as well. Read the instructions aboud the CKA and CKAD (https://docs.linuxfoundation.org/tc-docs/certification/tips-cka-and-ckad).
====
